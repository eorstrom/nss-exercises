...
// In the HTML, have one input field where someone can 
//   enter in a temperature.
// Create a radio button group where Celsius or Fahrenheit 
//   can be selected as the scale that the number should be converted to.
...
// in the input field.
// 
// Add an event handler to the input field that checks if 
//   the user pressed the enter key, and if that happens, 
